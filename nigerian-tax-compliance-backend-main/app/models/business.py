...
class Business(Base):
    ...
    paystack_public_key: Mapped[Optional[str]] = mapped_column(String(200), nullable=True)
    paystack_secret_key: Mapped[Optional[str]] = mapped_column(String(200), nullable=True)
